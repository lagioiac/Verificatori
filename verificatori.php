                    ...
                    <aside>
                        <div class="centered-wrapper">
                            ...
                            <div class="button-container" style="margin-bottom: 10px;">
                                ...
                                <!-- Nuovo report tabellare con metriche separate persone/competenze -->
                                <a href="report_verificatori_nuovo.php" class="button"> REPORT 📅 </a>

                                <!-- Nuovo report in versione grafica -->
                                <a href="report_verificatori_grafico.php" class="button"> REPORT 📊 </a>
